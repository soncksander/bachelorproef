...
- Opzoeken hoe toolcalls / structured output worden gedaan, zie daarvoor [OpenRouter docs](https://openrouter.ai/docs/quickstart) en [OpenAI docs](https://platform.openai.com/docs/guides/structured-outputs)
